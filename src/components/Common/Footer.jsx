                ...
                <div className="col-lg-3 col-md-6 col-sm-6">
                  <div className="widget widget_address_outer">
                    ...
                    <ul className="widget_address">
                      <li>
                        Corporate Head Office : 282, Momin Road (2nd Floor)
                        Jamal Khan Lane Kotowali Chittagong-4000
                      </li>
                      <li>infoetmsbd@gmail.com</li>
                      <li>(+88) 031-616905</li>
                      <li>(+88) 031-2862624</li>
                    </ul>
                  </div>
                </div>
                {/* USEFUL LINKS */}
              ...
              <div className="row">
                <div className="mt-footer-bot-center">
                  <span className="copyrights-text">
                    © 2024 ETMS BELVEDERE PROPERTY (BD) LTD. Designed By
                    M.K.Abir.
                  </span>
                </div>
              </div>
