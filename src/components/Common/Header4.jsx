...
class Header extends React.Component {
  constructor(props) {
    super(props);
    this.state = { logo: require("./../../resources/logo.png") };
  }
              ...
              <div className="row">
                <div className="mt-topbar-left clearfix">
                  <ul className="list-unstyled e-p-bx pull-right">
                    <li>
                      <i className="fa fa-envelope" /> infoetmsbd@gmail.com
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      282, Momin Road (2nd Floor) Jamal Khan Lane Kotowali
                      Chittagong-4000
                    </li>
                  </ul>
                </div>
                <div className="mt-topbar-right clearfix">
                  <div className="appint-btn">
                    <NavLink to={"/services"} className="site-button">
                      Book A Service
                    </NavLink>
                  </div>
                </div>
                  ...
                  <div className="contact-nav">
                    ...
                    <div className="contact-nav-form p-a30">
                      <div className="contact-info   m-b30">
                        ...
                        <div className="mt-icon-box-wraper center p-b30">
                          ...
                          <div className="icon-content">
                            ...
                            <p>
                              282, Momin Road (2nd Floor) Jamal Khan Lane
                              <br />
                              Kotowali Chittagong-400
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="text-center">
                        <h4 className="font-weight-600">© 2024 ETMS</h4>
                      </div>
                    </div>
                  </div>
                </div>
