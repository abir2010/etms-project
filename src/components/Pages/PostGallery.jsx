                ...
                <div className="blog-post date-style-3 blog-detail text-black">
                  ...
                  <div className="mt-post-meta ">
                    <ul>
                      <li className="post-date">
                        <strong>20 </strong> <span>April 2022</span>{" "}
                      </li>
                  ...
                  <div className="mt-post-title ">
                    <h3 className="post-title">
                      <NavLink to={"#"} className="font-weight-600">
                        From complete turn key to project manager.
                      </NavLink>
                    </h3>
                  </div>
                  <div className="mt-post-text">
                    <p>
                      ...
                      lectus. Vestibulum eleifend nisl sed massage sagittis
                    ...
                    <p>
                      {" "}
                      Proin tincidunt tellus ac porta volutpat. Cras mattis
                      congue lacus id bibendum. Mauris ut sodales libero.
                      Maecenas feugiat sit amet enim in accumsan. Here, then, is
                      what I wanted to tell you of my architecture. I created it
                      with courage and idealism, but also with an awareness of
                      the fact that what is important is life, friends, and
                      attempting to make this unjust world a better place in
                      which to live.
                    </p>
                    ...
                    <div className="row">
                      <div className="col-md-4 col-sm-4">
                        <div className="mt-box m-b30">
                          <div className="mt-media">
                            <img
                              src={require("./../../images/blog/large-blog.jpg")}
                              alt=""
                            />
                          </div>
                        </div>
                      ...
                      <div className="col-md-4 col-sm-4">
                        <div className="mt-box m-b30">
                          <div className="mt-media">
                            <img
                              src={require("./../../images/blog/large-blog2.jpg")}
                              alt=""
                            />
                          </div>
                        </div>
                      ...
                      <div className="col-md-4 col-sm-4">
                        <div className="mt-box m-b30">
                          <div className="mt-media">
                            <img
                              src={require("./../../images/blog/large-blog3.jpg")}
                              alt=""
                            />
                          </div>
                        </div>
                    ...
                    <p>
                      ...
                      type specimen book. remaining essentially unchanged. It
                      was popularised in the with the . Proin tincidunt tellus
                      ac porta volutpat.
                    </p>
                  </div>
